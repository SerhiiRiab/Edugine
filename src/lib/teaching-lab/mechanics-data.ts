...
export const TEACHING_LAB_MECHANICS: TeachingLabMechanic[] = [
  ...
  },
  {
    slug: 'sorting',
    name: 'Sorting',
    description: 'Students drag words, sentences, or ideas into the correct category. Set up 2-3 categories and let students sort — alone or together.',
    category: 'vocabulary',
    emoji: '🗂️',
    howItWorks: [
      'Tutor creates 2-3 categories and adds blocks (words, sentences, or ideas) to each',
      'Blocks are shuffled at the start of the session',
      'Students drag each block into the category they think it belongs to',
      'Individual mode: everyone sorts on their own screen, tutor sees every result',
      'Shared mode: the whole class sorts one board together in real time',
    ],
    bestFor: ['Vocabulary categorization', 'Grammar structures (regular vs irregular)', 'Idea grouping', 'Parts of speech'],
    example: 'Sorting food vocabulary into "Fruits", "Vegetables", and "Grains" categories',
  },
  {
    slug: 'sequence',
    name: 'Sequence',
    description: 'Students drag shuffled words, sentences, or steps into the correct order. Great for grammar word order and process/story sequencing.',
    category: 'grammar',
    emoji: '🔢',
    howItWorks: [
      'Tutor adds blocks (words, sentences, or steps) in the correct order',
      'Blocks are shuffled at the start of the session',
      'Students drag them back into what they believe is the right order',
      'Individual mode: everyone arranges their own copy, tutor sees every result',
      'Shared mode: the whole class arranges one sequence together in real time',
    ],
    bestFor: ['Word order in sentences', 'Story/process sequencing', 'Step-by-step instructions', 'Timeline events'],
    example: 'Arranging the steps of a business email (greeting, purpose, details, call to action, sign-off) in order',
  },
  {
    slug: 'word-cards',
    name: 'Word Cards',
    description: 'Classic two-sided flashcards. Students flip each card and self-check what they knew. Individual practice only — no shared mode.',
    category: 'vocabulary',
    emoji: '🗃️',
    howItWorks: [
      'Tutor creates two-sided cards: a front (word, sentence, or question) and a back (definition, translation, or answer)',
      'Student taps a card to flip it and reveal the back',
      'Student self-checks: "Knew it" or "Didn\'t know"',
      'Tutor sees every student\'s self-check results at the end',
    ],
    bestFor: ['Vocabulary drilling', 'Translation practice', 'Self-paced review', 'Spaced repetition warm-ups'],
    example: 'Flashcards with an English idiom on the front and its meaning on the back',
    bulkFormat: ['Front | Back'],
  },
]
