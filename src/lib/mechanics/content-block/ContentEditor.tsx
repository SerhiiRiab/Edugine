...
import type { ContentBlockItem, ContentBlockTFCard } from './types'
...
export function ContentBlockContentEditorPage({ set, initialItems }: Props) {
  ...
  const initial: ContentBlockItem = rawItem
    ...
    : { type: 'text', text: '', videoUrl: '', images: [], imageLayout: null, discussionQuestions: [], trueFalseCards: [] }
  ...
  function buildItem(overrides: Partial<ContentBlockItem> = {}): ContentBlockItem {
    return { type, text, videoUrl, images: [], imageLayout: null, discussionQuestions, trueFalseCards, ...overrides }
  }
