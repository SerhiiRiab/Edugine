...
// ── Shared participant shape (matches session-host-view ParticipantGameState subset) ──

interface HostParticipant {
  id: string
  nickname: string
  online: boolean
  cardIndex: number   // questions answered
  score: number
  correctCount: number
  totalSwipes: number // total questions answered
}
